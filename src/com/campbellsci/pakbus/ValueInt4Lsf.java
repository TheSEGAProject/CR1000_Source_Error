...
/**
 * Defines an object for managing four byte signed integers stored
 * with the least significant byte first from datalogger table records. 
 */
public class ValueInt4Lsf extends ValueBase
{
   protected ValueInt4Lsf(
