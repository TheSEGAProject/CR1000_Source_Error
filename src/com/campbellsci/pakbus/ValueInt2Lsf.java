...
/**
 * Defines an object for managing two byte signed integer values stored with 
 * the least significant byte first (little endian) from datalogger
 * table records. 
 */
public class ValueInt2Lsf extends ValueBase
{

   protected ValueInt2Lsf(
   ...
   { return new ValueInt2Lsf(column_def,array_offset); }
}
